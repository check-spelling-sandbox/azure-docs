...
description: This article describes how to connect your SAP system to Microsoft Sentinel by deploying the container that hosts the SAP data connector agent using the command line.
author: mberdugo
