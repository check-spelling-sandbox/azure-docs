...
:::image type="content" source="media/contact-center/contact-center-progression.svg" alt-text="Screenshot that shows a data flow diagram for a chat with a bot agent.":::
